...
var PlayerAnimationType = struct {
	...
	Default: Resource.Load[SpriteFrames.Instance]("res://animations/characters/Player/default.tres"),
	Idle:    Resource.Load[SpriteFrames.Instance]("res://animations/characters/Player/idle.tres"),
	Walk:    Resource.Load[SpriteFrames.Instance]("res://animations/characters/Player/walk.tres"),
}
